...
import { JalaliMonthLevelGroup, MonthLevelGroupStylesNames } from '../JalaliMonthLevelGroup';
import { JalaliYearLevelGroup, YearLevelGroupStylesNames } from '../JalaliYearLevelGroup';
import { JalaliDecadeLevelGroup, DecadeLevelGroupStylesNames } from '../JalaliDecadeLevelGroup';
import { CalendarLevel } from '../../types';
import { clampLevel } from './clamp-level/clamp-level';
import useStyles from './JalaliCalendar.styles';
import { MonthLevelSettings } from '../JalaliMonthLevel';
...
const defaultProps: Partial<JalaliCalendarProps> = {
  maxLevel: 'decade',
  minLevel: 'month',
...
export const JalaliCalendar = forwardRef<HTMLDivElement, JalaliCalendarProps>((props, ref) => {
  const {
    // CalendarLevel props
    maxLevel,
    minLevel,
...
JalaliCalendar.displayName = '@mantine-datepicker-jalali/JalaliCalendar';
