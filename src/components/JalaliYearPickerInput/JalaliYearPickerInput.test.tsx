...
describe('@mantine-datepicker-jalali/JalaliYearPickerInput', () => {
  itSupportsDateInputProps(JalaliYearPickerInput, defaultProps);
  itSupportsClearableProps(JalaliYearPickerInput, { ...defaultProps, defaultValue: new Date() });
  itSupportsYearsListProps(JalaliYearPickerInput, {
    ...defaultProps,
  ...
  it('supports valueFormat prop', () => {
    const { container, rerender } = render(
      <JalaliYearPickerInput {...defaultProps} valueFormat="YY" value={new Date(2022, 3, 11)} />
    );
