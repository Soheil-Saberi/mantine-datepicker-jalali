...
const defaultProps: Partial<JalaliDateInputProps> = {
  valueFormat: 'MMMM D, YYYY',
  fixOnBlur: true,
  preserveTime: true,
};

export const JalaliDateInput = forwardRef<HTMLInputElement, JalaliDateInputProps>((props, ref) => {
  const {
    inputProps,
    wrapperProps,
    value,
  ...
  return (
    <>
      ...
      <JalaliHiddenDatesInput name={name} form={form} value={_value} type="default" />
    </>
  );
});
