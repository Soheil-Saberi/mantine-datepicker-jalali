...
describe('@mantine-datepicker-jalali/JalaliMonthPickerInput', () => {
  itSupportsDateInputProps(JalaliMonthPickerInput, defaultProps);
  itSupportsClearableProps(JalaliMonthPickerInput, { ...defaultProps, defaultValue: new Date() });
  itSupportsYearsListProps(JalaliMonthPickerInput, {
    ...defaultProps,
    defaultLevel: 'decade',
    defaultValue: new Date(),
    popoverProps: { opened: true, withinPortal: false, transitionDuration: 0 },
  });
  itSupportsMonthsListProps(JalaliMonthPickerInput, {
    ...defaultProps,
    defaultValue: new Date(),
    popoverProps: { opened: true, withinPortal: false, transitionDuration: 0 },
  });
  ...
  it('supports valueFormat prop', () => {
    const { container, rerender } = render(
      <JalaliMonthPickerInput {...defaultProps} valueFormat="MMMM" value={new Date(2022, 3, 11)} />
    );
