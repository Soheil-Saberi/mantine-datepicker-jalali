...
import useStyles from './JalaliCalendarHeader.styles';
...
export interface JalaliCalendarHeaderProps
...
const defaultProps: Partial<JalaliCalendarHeaderProps> = {
  nextDisabled: false,
...
export const JalaliCalendarHeader = forwardRef<HTMLDivElement, JalaliCalendarHeaderProps>(
  (props, ref) => {
    const {
      className,
      nextIcon,
    ...
    return (
      <Box
        className={cx(classes.calendarHeader, className, locale === 'fa' && classes.calenderRtl)}
        ref={ref}
        {...others}
      >
        {withPrevious && (
