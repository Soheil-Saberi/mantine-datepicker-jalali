...
import { JalaliYearLevel, YearLevelStylesNames, YearLevelSettings } from '../JalaliYearLevel';
import { handleControlKeyDown } from '../../utils';
import useStyles from './JalaliYearLevelGroup.styles';

export type YearLevelGroupStylesNames = Selectors<typeof useStyles> | YearLevelStylesNames;

export interface JalaliYearLevelGroupProps
...
const defaultProps: Partial<JalaliYearLevelGroupProps> = {
  numberOfColumns: 1,
};

export const JalaliYearLevelGroup = forwardRef<HTMLDivElement, JalaliYearLevelGroupProps>(
  (props, ref) => {
    const {
      // YearLevel settings
      year,
...
JalaliYearLevelGroup.displayName = '@mantine-datepicker-jalali/JalaliYearLevelGroup';
