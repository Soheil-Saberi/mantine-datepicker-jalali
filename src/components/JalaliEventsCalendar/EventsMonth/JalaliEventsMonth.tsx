...
import { getMonthDays, isSameMonth } from '../../JalaliMonth';
import { DayOfWeek } from '../../../types';
import useStyles from './JalaliEventsMonth.styles';
import { useDatesContext } from '../../JalaliDatesProvider';
import { getWeekdayNames } from '../../JalaliWeekdaysRow';
...
export interface JalaliEventsMonthProps
...
const defaultProps: Partial<JalaliEventsMonthProps> = {
  __staticSelector: 'EventsMonth',
  weekdayFormat: 'dd',
  events: [],
};

export const JalaliEventsMonth = forwardRef<HTMLDivElement, JalaliEventsMonthProps>(
  (props, ref) => {
    const {
      className,
      classNames,
...
JalaliEventsMonth.displayName = '@mantine-datepicker-jalali/JalaliEventsMonth';
