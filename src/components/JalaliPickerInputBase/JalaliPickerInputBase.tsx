...
import { JalaliHiddenDatesInput, HiddenDatesInputValue } from '../JalaliHiddenDatesInput';
import { CalendarStylesNames } from '../JalaliCalendar';
import useStyles from './JalaliPickerInputBase.styles';
...
export interface JalaliPickerInputBaseProps extends DateInputSharedProps {
...
const defaultProps: Partial<JalaliPickerInputBaseProps> = {};

export const JalaliPickerInputBase = forwardRef<HTMLButtonElement, JalaliPickerInputBaseProps>(
  (props, ref) => {
    const {
      inputProps,
      wrapperProps,
    ...
    return (
      <>
        ...
        <JalaliHiddenDatesInput value={value} name={name} form={form} type={type} />
      </>
    );
  }
);

JalaliPickerInputBase.displayName = '@mantine-datepicker-jalali/JalaliPickerInputBase';
