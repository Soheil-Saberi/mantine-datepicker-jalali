...
const defaultProps: JalaliWeekdaysRowProps = {};

function Wrapper(props: Partial<JalaliWeekdaysRowProps>) {
  return (
    <table>
      <thead>
        <JalaliWeekdaysRow {...defaultProps} {...props} />
      </thead>
    </table>
  );
}

describe('@mantine-datepicker-jalali/JalaliWeekdaysRow', () => {
