...
import useStyles from './JalaliDecadeLevelGroup.styles';

export type DecadeLevelGroupStylesNames = Selectors<typeof useStyles> | DecadeLevelStylesNames;

export interface JalaliDecadeLevelGroupProps
...
const defaultProps: Partial<JalaliDecadeLevelGroupProps> = {
  numberOfColumns: 1,
};

export const JalaliDecadeLevelGroup = forwardRef<HTMLDivElement, JalaliDecadeLevelGroupProps>(
  (props, ref) => {
    const {
...
JalaliDecadeLevelGroup.displayName = '@mantine-datepicker-jalali/JalaliDecadeLevelGroup';
