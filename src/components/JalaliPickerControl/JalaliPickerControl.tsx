...
import useStyles from './JalaliPickerControl.styles';

export type PickerControlStylesNames = Selectors<typeof useStyles>;

export interface JalaliPickerControlProps
...
const defaultProps: Partial<JalaliPickerControlProps> = {};

export const JalaliPickerControl = forwardRef<HTMLButtonElement, JalaliPickerControlProps>(
  (props, ref) => {
    const {
      className,
      children,
...
JalaliPickerControl.displayName = '@mantine-datepicker-jalali/JalaliPickerControl';
