...
import { JalaliHiddenDatesInput } from './JalaliHiddenDatesInput';

describe('@mantine-datepicker-jalali/JalaliHiddenDatesInput', () => {
  it('sets name and form on the input', () => {
    const { container } = render(
      <JalaliHiddenDatesInput
        name="test-name"
        form="test-form"
        type="default"
  ...
  it('formats date correctly for type="default"', () => {
    ...
    rerender(
      <JalaliHiddenDatesInput name="test-name" form="test-form" type="default" value={null} />
    );
  ...
  it('formats date correctly for type="multiple"', () => {
    ...
    rerender(
      <JalaliHiddenDatesInput name="test-name" form="test-form" type="multiple" value={[]} />
    );
    expect(container.firstChild).toHaveValue('');
  });
  ...
  it('formats date correctly for type="range"', () => {
    ...
    rerender(
      <JalaliHiddenDatesInput name="test-name" form="test-form" type="range" value={[null, null]} />
    );
    expect(container.firstChild).toHaveValue('');
  });
});
