...
import useStyles, { DayStylesParams } from './JalaliDay.styles';

export type DayStylesNames = Selectors<typeof useStyles>;

export interface JalaliDayProps
...
const defaultProps: Partial<JalaliDayProps> = {
  tabIndex: 0,
};

export const JalaliDay = forwardRef<HTMLButtonElement, JalaliDayProps>((props, ref) => {
  const {
    className,
    date,
    radius,
...
JalaliDay.displayName = '@mantine-datepicker-jalali/JalaliDay';
